 ...
 * dele) viaja na URL de autorização. Na troca do code, o provedor confere que o
 * `verifier` bate com o `challenge` — por isso o `verifier` precisa sobreviver do
 * `connect` até o `callback` (carregamos num cookie httpOnly de vida curta).
 */

...
import { SOCIAL_TOKEN_ENCRYPTION_KEY } from "@/lib/env/_server";

/**
 * Cifragem de tokens OAuth em repouso (AES-256-GCM).
 *
 * Formato persistido: `iv.authTag.ciphertext`, cada parte em base64. O IV é
 * aleatório por operação (12 bytes, recomendado para GCM) e o auth tag garante
 * integridade. A chave vem de `SOCIAL_TOKEN_ENCRYPTION_KEY` (base64 de 32 bytes).
 */

 ...
 * permite o publish do Instagram (o Graph API exige `image_url` acessível, sem
 * upload direto). Sem auth — o `token` é o próprio "segredo" (24 bytes random
 * URL-safe), curto-vivo (~10min) e descartável após o publish.
 */

...
import { EmailEditorShell } from "@/components/email/email-editor-shell";
...
/**
 * Painel lateral grande com o editor de email (@react-email/editor) — espelha
 * o `RichTextPanel` em chrome e dimensões. Carrega o conteúdo inicial e
 * devolve o HTML em `onSave`.
 */

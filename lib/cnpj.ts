 ...
 * espelha a base pública da Receita Federal. Usado para preencher os dados da
 * empresa (razão social, nome fantasia, endereço) a partir do CNPJ digitado.
 */
...
/** Resultado da consulta: campos da empresa prontos para preencher a grade. */
...
/** Monta o `CompanyAddress` a partir da resposta; `null` se nada útil veio. */
function toAddress(data: BrasilApiCnpjResponse): CompanyAddress | null {
